...
var MyBreadcrumbs = function (props) {
    ...
    var msgId = 'MUBP.Breadcrumbs';
    return (react_1.default.createElement(core_1.Box, { m: 2, "data-testid": msgId },
        react_1.default.createElement(core_1.Breadcrumbs, { separator: react_1.default.createElement(icons_1.NavigateNext, { fontSize: "small" }), "aria-label": "breadcrumb" }, props.links.map(function (obj, idx) {
            var label = formatMessage({ id: obj.intlID });
            if (obj.href) {
                return (react_1.default.createElement(core_1.Link, { "data-testid": msgId + idx, key: idx, color: "inherit", onClick: handleClick(obj.href) },
                    react_1.default.createElement(MyBox, null, label)));
            }
            else {
                return (react_1.default.createElement(MyBox, { "data-testid": msgId + idx, key: idx, color: "text.primary" }, label));
            }
        }))));
};
