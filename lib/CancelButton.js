...
var CancelButton = function (props) {
    ...
    return (react_1.default.createElement(core_1.Box, { className: classes.item },
        react_1.default.createElement(MyButton_1.default, __assign({}, props, { label: formatMessage({ id: 'MUIBP.cancel', defaultMessage: 'Cancel' }), variant: "contained", fullWidth: true, "data-testid": "cancel-button" }))));
};
