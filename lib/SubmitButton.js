...
var SubmitButton = function (props) {
    ...
    return (react_1.default.createElement(core_1.Box, { className: classes.item },
        react_1.default.createElement(MyButton_1.default, __assign({}, copyProps, { label: props.label || formatMessage({ id: msgId, defaultMessage: 'Submit' }), loading: loading, type: "submit", color: "primary", fullWidth: true, "data-testid": msgId }))));
};
